package com.carlosorozco.webapp.biblioteca.controller;
...
import com.carlosorozco.webapp.biblioteca.model.Prestamo;
import com.carlosorozco.webapp.biblioteca.service.PrestamoService;
...
public class PrestamoController {
    ...
    public ResponseEntity<Map<String, String>> agregarPrestamo(@RequestBody Prestamo prestamo){
        ...
        try {
            if(prestamoService.guardarPrestamo(prestamo ).equals(1)){
                response.put("message","Prestamo creado con exito");
                return ResponseEntity.ok(response);
            }else if(prestamoService.guardarPrestamo(prestamo).equals(2)){
